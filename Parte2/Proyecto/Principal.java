...
labelTitle = new JLabel("Datos de el Trabajador para el cálculo de vacaciones");
...
comboAntiguedad.addItem("2 a 6 años de sevicio");
comboAntiguedad.addItem("7 años o mas de servicio");

labelResultado = new JLabel("Resultado de Cálculo");
...
labelfooter = new JLabel("©2023 The Coca-Cola Company | Todos los derechos resevados");
...
if(Departamento.equals("Atención al Cliente")){
 ...
 if(Antiguedad.equals("2 a 6 años de sevicio")){
 textarea1.setText("\n  El Trabajador " + nombreTrabajador + " " + AP + " " + AM +
                  "\n  quien labora en " + Departamento + " con " +  Antiguedad + 
...
JOptionPane.showMessageDialog(null,"Desarrollado por Brian Hazel\n" +
                                   "     www.youtube.com/Briraptor");
  }
 }
